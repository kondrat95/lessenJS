...
const imgSlider = document.getElementById('web-tech-image');

let startIndex = 0;
imgSlider.src = WEB_TECH_IMAGES[startIndex];

prevButton.addEventListener('click', (e) => {
  startIndex = (startIndex - 1 + WEB_TECH_IMAGES.length ) % WEB_TECH_IMAGES.length;
  imgSlider.src = WEB_TECH_IMAGES[startIndex];
})

nextButton.addEventListener('click', (e) => {
  startIndex = (startIndex + 1) % WEB_TECH_IMAGES.length;
  imgSlider.src = WEB_TECH_IMAGES[startIndex];
})